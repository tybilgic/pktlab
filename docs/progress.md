...
| PLN-009 | Datapath Status, Stats, and User Surface | in progress | 2026-04-15 | `a27720c` | read-only status/stats surfacing is in place through IPC, controller routes, and the CLI; writable datapath controls remain |
